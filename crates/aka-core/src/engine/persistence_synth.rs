...
use super::persistence_access_synth::{
    detect_table_access_edges, normalize_table_access_key, table_access_edges_for_sql,
    TableAccessEntity, TableAccessRef, TableAccessRepository,
};
use super::{
...
fn detect_mybatis_xml_table_access_edges(
    repo: &Path,
