...
Codex 没有内置 skill/plugin 机制。想让 Codex 更稳定地选择 aka 工具，可把 [`AGENTS-aka.md`](./AGENTS-aka.md) 的内容追加到项目 `AGENTS.md` 或全局 Codex 指令里；它强调 `list_repos`、workspace roots 自动索引、服务端工作目录/路径参数兜底、`analyze` 保底和各工具选择规则。
